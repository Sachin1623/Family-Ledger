    ...
    return (
      <div className="flex flex-col min-h-screen bg-surface">
        ...
        <header className="p-4 flex items-center gap-3 bg-white border-b border-border-subtle">
          <button onClick={() => navigate('/games/spadePledge')} className="text-text-muted">
      ...
      <div className="flex flex-col min-h-screen bg-surface">
        ...
        <div className="relative shrink-0 bg-primary/5 border-b border-border-subtle px-4 py-4 text-center overflow-hidden">
          ...
          <div className="relative flex items-center gap-2 mt-3">
            ...
            <button onClick={() => navigate('/games/spadePledge')} className="flex-1 py-2.5 bg-primary text-white font-bold rounded-2xl text-sm">
              Back to Lobby
            </button>
