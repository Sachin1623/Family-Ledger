...
export const SEARCHABLE_FEATURES: SearchableFeature[] = [
  ...
  { id: 'balances', label: 'Splits', description: 'See who owes who across your groups', labelKey: 'nav.balances', descriptionKey: 'search.balancesDesc', icon: 'call_split', route: '/settlements', keywords: ['balances', 'settlements', 'settle up', 'owe'] },
  ...
  { id: 'game-rummy13', label: '13-Card Rummy', description: 'Card game, online multiplayer', labelKey: 'games.rummy13', descriptionKey: 'games.rummy13Desc', icon: 'style', route: '/games/rummy13', keywords: ['cards'] },
